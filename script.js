...
async function handleLoadMore() {
    ...
    const schema = {
        ...
        items: {
            ...
            required: ["name", "description", "address", "cost"]
        }
    };
        ...
        if (newActivities && newActivities.length > 0) {
            newActivities.forEach(activity => {
                const newActivity = {
                    ...
                    time: null, // Estimated time is not available from this API call
